...
const destinationsContainer =
    document.getElementById('destinations-container');

const addDestinationButton =
    document.getElementById('add-destination-button');

const destinationModal =
    document.getElementById('destination-modal');

const closeDestinationModal =
    document.getElementById('close-destination-modal');

const destinationForm =
    document.getElementById('destination-form');

const destinationModalTitle =
    document.getElementById('destination-modal-title');

const destinationId =
    document.getElementById('destination-id');

const departureModal =
    document.getElementById('departure-modal');

const closeDepartureModal =
    document.getElementById('close-departure-modal');

const departureForm =
    document.getElementById('departure-form');

const departureModalTitle =
    document.getElementById('departure-modal-title');

const departureDestinationId =
...
function openAddDepartureModal(
    ...
    departureModalTitle.textContent =
        'Add Departure';
    ...
    departureStartDate.min =
        today;

    departureEndDate.min =
        today;


    departureModal.classList.add(
        'active'
    );
}
...
function attachDepartureEvents(
    destinations
) {
...
if (endDate < today) {
    ...
    return;
        ...
        const totalSeats =
            Number(departureTotalSeats.value);
...
departureModal.classList.remove(
    'active'
);
...
alert(
    isEditing
        ...
        : 'Departure added successfully.'
            ...
            console.error(
                'Departure save failed:',
                error
            );

            alert(
                error.message ||
                'Unable to save departure.'
            );
        }
    }
);
...
departureStartDate.addEventListener(
    'change',
    () => {
...
const destinationFilter =
    document.getElementById('destination-filter');
...
const destinationImagePreview =
    document.getElementById(
        'destination-image-preview'
    );

const destinationImagePreviewImg =
    document.getElementById(
...
destinationImage.addEventListener(
    'change',
    () => {

        const file =
            destinationImage.files[0];

        if (!file) {

            destinationImagePreview.style.display =
                'none';
        ...
        destinationImagePreviewImg.src =
            imageUrl;
...
function attachDestinationEvents() {
    ...
    document
        .querySelectorAll('.edit-destination-button')
        .forEach(button => {
    ...
    document
        .querySelectorAll('.delete-destination-button')
        .forEach(button => {
...
destinationImagePreview.style.display =
    'block';
        ...
        destinationModalTitle.textContent =
            'Edit Destination';
...
closeDestinationModal.addEventListener(
    'click',
    () => {
...
closeDepartureModal.addEventListener(
    'click',
    () => {
...
async function viewBookingDetails(id) {
    try {
        ...
        document
            ...
            const cancelButton =
                document.querySelector('.cancel-booking-button');
